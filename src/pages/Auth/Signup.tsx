    ...
    <div className="auth-slide-up">
      ...
      <div className="flex flex-col items-start mb-6">
        ...
        <button
          ...
          className="relative group w-20 h-20 rounded-full overflow-hidden border-2 border-dashed border-gray-300 hover:border-emerald-400 transition-colors duration-200"
        >
          {formData?.avatar ? (
            <>
              <img
            ...
            <div className="w-full h-full bg-gray-100 flex flex-col items-center justify-center gap-1 group-hover:bg-gray-50 transition-colors">
              <svg
